...
set CLASSPATH=%APP_HOME%\lib\starter-1.0.0-SNAPSHOT.jar;%APP_HOME%\lib\vertx-web-client-3.8.5.jar;%APP_HOME%\lib\vertx-jdbc-client-3.8.5.jar;%APP_HOME%\lib\vertx-web-3.8.5.jar;%APP_HOME%\lib\postgresql-42.2.5.jar;%APP_HOME%\lib\vertx-web-common-3.8.5.jar;%APP_HOME%\lib\vertx-sql-common-3.8.5.jar;%APP_HOME%\lib\vertx-auth-common-3.8.5.jar;%APP_HOME%\lib\vertx-core-3.8.5.jar;%APP_HOME%\lib\c3p0-0.9.5.4.jar;%APP_HOME%\lib\vertx-bridge-common-3.8.5.jar;%APP_HOME%\lib\netty-handler-proxy-4.1.42.Final.jar;%APP_HOME%\lib\netty-codec-http2-4.1.42.Final.jar;%APP_HOME%\lib\netty-codec-http-4.1.42.Final.jar;%APP_HOME%\lib\netty-handler-4.1.42.Final.jar;%APP_HOME%\lib\netty-resolver-dns-4.1.42.Final.jar;%APP_HOME%\lib\netty-codec-socks-4.1.42.Final.jar;%APP_HOME%\lib\netty-codec-dns-4.1.42.Final.jar;%APP_HOME%\lib\netty-codec-4.1.42.Final.jar;%APP_HOME%\lib\netty-transport-4.1.42.Final.jar;%APP_HOME%\lib\netty-buffer-4.1.42.Final.jar;%APP_HOME%\lib\netty-resolver-4.1.42.Final.jar;%APP_HOME%\lib\netty-common-4.1.42.Final.jar;%APP_HOME%\lib\jackson-databind-2.9.9.1.jar;%APP_HOME%\lib\jackson-core-2.9.9.jar;%APP_HOME%\lib\mchange-commons-java-0.2.15.jar;%APP_HOME%\lib\jackson-annotations-2.9.0.jar
